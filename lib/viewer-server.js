...
const serveLocalHtml = async (res, viewerRoot) => {
...
// of jscad.rkroll.com, so rendering works offline.
export const startViewerServer = (
  ...
  new Promise((resolve, reject) => {
    ...
    const server = createServer(async (req, res) => {
      ...
      try {
        if (pathname === "/") {
          if (viewerRoot) return await serveLocalHtml(res, viewerRoot);
          return proxyHtmlWithInjection(req, res);
        }
        try {
