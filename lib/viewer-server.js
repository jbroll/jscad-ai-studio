...
// `viewerRoot` is a built jscadui viewer (apps/jscad-web/build) served in place
// of jscad.rkroll.com, so rendering works offline. Unset JSCAD_VIEWER_ROOT and
// JSCAD_LOCAL_PACKAGES default to the sibling builds next to this repo, so an
// unpublished jscad-anchors/jscad-fluent and the local viewer are picked up
// without configuration; an empty-string value opts out.
